...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(router, Provider, storage, toastCtrl) {
        this.router = router;
    ...
    RegisterPage.prototype.prosesRegister = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.email == "")) return [3 /*break*/, 2];
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 9];
                    case 4:
                        if (!(this.password != this.confirm_password)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.toastCtrl.create({
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 9];
                    case 6:
                        if (!(this.status == "")) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.toastCtrl.create({
