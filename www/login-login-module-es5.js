...
var LoginPage = /** @class */ (function () {
    function LoginPage(router, Provider, storage, platform, toastCtrl) {
        this.router = router;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.Provider.postData(body, 'login.php').subscribe(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var alertpesan, toast, toast, toast, toast;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        alertpesan = data.msg;
                                        if (!data.success) return [3 /*break*/, 7];
                                        if (!(data.result['status'] == 'y')) return [3 /*break*/, 2];
                                    ...
                                    case 1:
                                        ...
                                        return [3 /*break*/, 6];
                                    case 2:
                                        if (!(data.result['status'] == 'n')) return [3 /*break*/, 4];
                                        this.storage.set('session_storage', data.result);
                                    ...
                                    case 3:
                                        ...
                                        return [3 /*break*/, 6];
                                    case 4:
                                        if (!(data.result['status'] == '')) return [3 /*break*/, 6];
                                        this.storage.set('session_storage', data.result);
                                        return [4 /*yield*/, this.toastCtrl.create({
                                                message: 'error',
                                                duration: 3000
                                    ...
                                    case 6:
                                        ...
                                        console.log(data);
                                        return [3 /*break*/, 9];
                                    case 7: return [4 /*yield*/, this.toastCtrl.create({
                                            message: alertpesan,
                                            duration: 2000
                                        })];
                                    case 8:
    ...
    LoginPage.prototype.myJob = function () {
