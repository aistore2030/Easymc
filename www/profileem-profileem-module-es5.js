...
var ProfileemPageRoutingModule = /** @class */ (function () {
    function ProfileemPageRoutingModule() {
    }
    ...
    return ProfileemPageRoutingModule;
}());
...
var ProfileemPageModule = /** @class */ (function () {
    function ProfileemPageModule() {
    }
...
var ProfileemPage = /** @class */ (function () {
    function ProfileemPage(actionSheetController, router, storage, toastCtrl, Provider) {
    ...
    ProfileemPage.prototype.ngOnInit = function () {
    };
    ProfileemPage.prototype.presentActionSheet = function () {
        var _this = this;
        this.actionSheet = this.actionSheetController.create({
            ...
            buttons: [{
                    ...
                    icon: 'create',
                    handler: function () {
                        _this.router.navigate(['/employer/profileem/editprofileemployer']);
                    }
                }, {
                    text: 'Logout',
                    icon: 'log-out',
    ...
    ProfileemPage.prototype.updateCustomer = function (id, employ_id, fname, lname, location, info) {
        this.router.navigate(['/employer/profileem/editprofileemployer/' + id + '/' + employ_id + '/' + fname + '/' + lname + '/' + location + '/' + info]);
    };
    ProfileemPage.prototype.prosesLogout = function () {
    ...
    ProfileemPage.prototype.onRateChange = function (event) {
        console.log('Your rate:', event);
    };
    ProfileemPage.ctorParameters = function () { return [
...
//# sourceMappingURL=profileem-profileem-module-es5.js.map