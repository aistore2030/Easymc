...
var map = {
	...
	"../notificationem/notificationem.module": [
...
/* harmony import */ var _providers_post_provider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../providers/post-provider */ "./src/providers/post-provider.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _providers_post_provider__WEBPACK_IMPORTED_MODULE_10__["PostProvider"],
...
var Provider = /** @class */ (function () {
    ...
    function Provider(http, storage) {
        this.http = http;
        this.storage = storage;
        this.server = "http://192.168.64.2/server_easymc/";
    }
    Provider.prototype.postData = function (body, file) {
        var type = "application/json; charset=UTF-8";
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]({ 'Content-Type': type });
    ...
    Provider = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"], _ionic_Storage__WEBPACK_IMPORTED_MODULE_4__["Storage"]])
    ], Provider);
    return Provider;
}());
...
/***/ "./src/providers/post-provider.ts":
/*!****************************************!*\
  !*** ./src/providers/post-provider.ts ***!
  \****************************************/
...
var PostProvider = /** @class */ (function () {
    ...
    function PostProvider(http) {
        this.http = http;
        this.server = "http://localhost/IONIC4_CRUD_LOGINREGIS_PHP_MYSQL/server_api/";
    }
    ...
    PostProvider.ctorParameters = function () { return [
        { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
    ]; };
...
module.exports = __webpack_require__(/*! /Users/jones/Easymc/src/main.ts */"./src/main.ts");
