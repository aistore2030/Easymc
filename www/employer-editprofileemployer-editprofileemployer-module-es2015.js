 ...
 * @hidden
 */
const /** @type {?} */ StorageConfigToken = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('STORAGE_CONFIG_TOKEN');
/**
 * @hidden
 * @param {?} storageConfig
 * @return {?}
...
let EditprofileemployerPageRoutingModule = class EditprofileemployerPageRoutingModule {
};
...
let EditprofileemployerPageModule = class EditprofileemployerPageModule {
};
...
let EditprofileemployerPage = class EditprofileemployerPage {
    constructor(camera, transfer, file, http, webview, actionSheetController, toastController, storage, plt, loadingController, ref, filePath, actRoute, router, Provider) {
        this.camera = camera;
...
EditprofileemployerPage.ctorParameters = () => [
...
//# sourceMappingURL=employer-editprofileemployer-editprofileemployer-module-es2015.js.map